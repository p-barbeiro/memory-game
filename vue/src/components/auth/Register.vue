...
<template>
  <div class="place-self-center flex flex-col w-full md:flex-row justify-between items-center h-full">
    <div class="h-full md:w-1/2 md:border-r">
      <img class="md:h-full rounded md:rounded-l-xl md:rounded-r-none object-contain" src="/src/assets/img/login.jpg" alt="" loading="eager"/>
    </div>
